...
(id, station_id, transformer_id, connection_id, device_id, value, measurement_type, measured_at, sent_at, received_at, customer_id, created_at, updated_at)
VALUES('00000000-0000-0000-0000-000000000001'::uuid,
        '10000000-0000-0000-0000-000000000000'::uuid,
        '00000000-1000-0000-0000-000000000000'::uuid,
        '00000000-0000-1000-0000-000000000000'::uuid,
        '00000000-0000-0000-1000-000000000000'::uuid, -3.14,
        'VOLTAGE'::public."measurementtype", '2022-12-23 09:46:50.853',
        '2024-10-23 18:56:50.853', '2024-10-23 18:56:50.853', NULL, '2024-10-23
        18:59:02.510', '2024-10-23 18:59:02.510')
ON CONFLICT (id) DO NOTHING;
...
VALUES('00000000-0000-0000-0000-000000000002'::uuid,
        ...
        '00000000-1000-0000-0000-000000000000'::uuid,
        '00000000-0000-1000-0000-000000000000'::uuid,
        '00000000-0000-0000-1000-000000000000'::uuid, 1.4142,
        'CURRENT'::public."measurementtype", '2023-08-23 12:46:50.853',
        '2024-10-23 18:56:50.853', '2024-10-23 18:57:50.853', NULL, '2024-10-23 18:59:02.510', '2024-10-23
        18:59:02.510')
ON CONFLICT (id) DO NOTHING;
...
VALUES('00000000-0000-0000-0000-000000000003'::uuid,
        '10000000-0000-0000-0000-000000000000'::uuid,
        '00000000-1000-0000-0000-000000000000'::uuid,
        '00000000-0000-2000-0000-000000000000'::uuid,
        '00000000-0000-0000-2000-000000000000'::uuid, 2.81,
        'VOLTAGE'::public."measurementtype", '2024-05-23 17:46:50.853',
        '2024-10-23 18:56:50.853', '2024-10-23 18:57:50.853', NULL, '2024-10-23
        18:59:02.510', '2024-10-23 18:59:02.510')
ON CONFLICT (id) DO NOTHING;
...
VALUES('00000000-0000-0000-0000-000000000004'::uuid,
        '10000000-0000-0000-0000-000000000000'::uuid,
        '00000000-1000-0000-0000-000000000000'::uuid, NULL,
        '00000000-0000-0000-3000-000000000000'::uuid, 1.57,
        'VOLTAGE'::public."measurementtype", '2024-10-22 05:46:50.853',
        '2024-10-23 18:56:50.853', '2024-10-23 18:57:50.853', NULL, '2024-10-23
        18:59:02.510', '2024-10-23 18:59:02.510')
ON CONFLICT (id) DO NOTHING;
